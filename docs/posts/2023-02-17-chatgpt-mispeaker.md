---
title: "ChatGPT-MiSpeaker"
date: 2023-02-17
author: pengjianqing
categories: ['Tech']
tags: ['ChatGPT', 'MiSpeaker', 'OpenAI', 'XiaoAi']
---
...
{
    "conversation_id": "c379851d-fbd4-479e-a716-dddc379fb07c",
...
```
`python ChatGPT-MiSpeaker.py --hardware HARDWARE`
```

Replace HARDWARE with the identifier of your MiSpeaker, such as LX06, L05B, S12A, or LX01.

```
`python3 ChatGPT-MiSpeaker.py --hardware "$MI_HARDWARE"
0
